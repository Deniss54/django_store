...
from users.forms import UserLoginForm, UserProfileForm, UserRegisterationForm
...
class UserRegistrationView(CommonMixin, SuccessMessageMixin, CreateView):
    ...
    success_message = 'Регистрация прошла успешно. На почту выслано письмо для подтверждения'
